...
impl BasaltApp {
                    ...
                    if let Some(tile) = selected_tile {
                        ...
                        match tile.kind {
                            InstallTileKind::Mattmc => {
                                if ui
                                    .add_enabled(
                                        ...
                                        egui::Button::new(
                                            RichText::new("Install MattMC").size(body_text_size),
                                        ),
                                    )
                                    .clicked()
                                {
                            ...
                            InstallTileKind::EmulatorCore(system) => {
                                let status =
                                    match core::is_emulation_core_installed_for_system(system) {
                                        Ok(true) => "Installed",
                                ...
                                if ui
                                    .add_enabled(
                                        can_start_background_job,
                                        egui::Button::new(
                                            RichText::new("Sync Roms Up").size(body_text_size),
                                        ),
                                    )
                                    .clicked()
                                {
                                ...
                                if ui
                                    .add_enabled(
                                        can_start_background_job,
                                        egui::Button::new(
                                            RichText::new("Sync Roms Down").size(body_text_size),
                                        ),
                                    )
                                    .clicked()
                                {
                                ...
                                if supports_save_sync {
                                    if ui
                                        .add_enabled(
                                            can_start_background_job,
                                            egui::Button::new(
                                                RichText::new("Sync Saves Up").size(body_text_size),
                                            ),
                                        )
                                        .clicked()
                                    {
    ...
    fn categorized_install_tiles(
        &self,
        tiles: &[InstallTile],
    ) -> Vec<(&'static str, Vec<InstallTile>)> {
